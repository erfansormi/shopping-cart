        ...
        <>
            <div className={styles.cartBox}>
                <div className={styles.titleBox}>
                    <h4 className="text-uppercase fw-bold me-3">your cart info</h4>
                    ...
                    {cartState.allQuantity >= 1 ? (
                        <div>
                            <div className="d-flex align-items-center ">
                                <h5 className="me-2 my-0 fs-5  opacity-75 text-lowercase">
                            ...
                            <div className="d-flex align-items-center mt-3">
                                ...
                                <span className="fw-bold fs-5">$ {cartState.total}</span>
                            </div>
                            <div className="mt-5 d-flex justify-content-between">
                                <button
                                    className="btn btn-success text-uppercase"
                                    onClick={() => cartDispatch({ type: "CHECKOUT" })}
                                >
                                    checkout
                                </button>
                                <button
